...
return (
    <Container>
      ...
      <Typography variant="h3" color="title">Мои данные</Typography>
        ...
        <form onSubmit={handleSubmit(sendAvatar)}>
            <div className={s.profile__avatar}>
                <img className={s.profile__avatar__img} src={user?.avatar} alt="" />
                <Input 
        ...
        <form onSubmit={handleSubmit(sendProfileData)}>
            ...
            <Input {...register('email')} disabled defaultValue={user?.email} placeholder="email"></Input>
            <Input {...register('id')} disabled defaultValue={user?._id} placeholder="id"></Input>
            <Stack direction="flex" flexDirection="column" gap="15px" >
